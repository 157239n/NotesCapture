...
$router->get(CHARACTERISTIC_HASH . "/resources/js/*", function () use ($requestData) {
    \header("Content-Type: text/javascript");
    @include(__DIR__ . "/../resources/js/" . $requestData->getExplodedPath()[3]);
});

$router->getPost(CHARACTERISTIC_HASH . "/ctrls/*", function () use ($requestData, $authenticator, $session, $timezone, $userFactory, $categoryFactory, $websiteFactory, $highlightFactory) {
